...
# pyspark_databricks documentation build
...
from pyspark_databricks import __version__ as release

# -- Project information -----------------------------------------------------

project = "pyspark_databricks"
author = "Kedro"
...
htmlhelp_basename = "pyspark_databricksdoc"
...
latex_documents = [
    (
        master_doc,
        "pyspark_databricks.tex",
        "pyspark_databricks Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pyspark_databricks",
        "Project pyspark_databricks codebase.",
        "Data-Science",
    )
]
